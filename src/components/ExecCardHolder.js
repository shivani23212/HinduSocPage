...
function ExecCardHolder() {
    return (
        ...
        <div className="exec__card__holder">
            ...
            <div className="rangoli-container"><img src="images/rangoli.png" alt="rangoli drawing" className="rangoli-design" /></div>
            {/* <img src="images/rangoli.png" alt="rangoli drawing" className="rangoli-design" /> */}
